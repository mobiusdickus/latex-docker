...
\name{Colin}{Chan}
\address{26-05 28th Street Astoria, NY 11102 Apt. 3D}
\mobile{(646)-409-2163}

\email{colin@ctchan.me}
\homepage{ctchan.me}
\github{mobiusdickus}
\linkedin{colin-th-chan}
%\skype{skypeid}
...
\quote{``Let's make something cool."} % A quote or statement

\makecvfooter{\today}{Colin Chan~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
