...
\vspace{\topsep}
\begin{tightemize}
\item Design and implement LLM-powered pipelines that extract, normalize, and enrich unstructured insurance data into queryable analytics datasets.
\item Build and maintain ETL infrastructure processing millions of records across heterogeneous data sources with end-to-end validation and monitoring.
\item Own AWS platform architecture including SageMaker, Glue, and Redshift, establishing patterns for cost-effective, production-grade data workloads.
...
\section{Other}
\textbf{Taste Crème} | Co-founded a bake shop and cafe in Long Island City, NY (2019–present).
\vspace{4pt}
\newline
...
GitHub Actions \textbullet{} dbt \textbullet{} \\
