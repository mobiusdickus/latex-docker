...
\begin{tightemize}
\sectionsep
\item Leading a small engineering team to design and deliver the core product platform in a startup environment.
\item Architect secure, modular infrastructure on GCP with Terraform, Docker, and CI/CD pipelines enabling future scalability with Kubernetes and operational reliability.
...
\item Increased productivity by streamlining development workflows through Docker-based containerized environments, task automation with Makefiles and scripts, and improved internal documentation.
...
\item Integrated two tech stacks during a merger, ensuring uninterrupted service for a sudden increase in the user base.
